...
struct KO_BYTE_PATTERNS{
  ...
  // Not tested with another human character. 
  // Raw: 0F 00 00 00 FF D2 64 FF
  KO_MEM_BYTE current_hp_byte_pattern_human[KO_STRING_LENGTH_IN_BYTES] = {0x0F, 0x00, 0x00, 0x00, 0xFF, 0xD2, 0x64, 0xFF};
  KO_MEM_BYTE current_hp_offset_from_pattern                           = 0x20; // This should be interpreted as 4 bytes (uint32_t). 
