...
struct KO_BYTE_PATTERNS{
  ...
  */
  ...
  KO_MEM_BYTE current_hp_byte_pattern[KO_STRING_LENGTH_IN_BYTES] = {0x00, 0x00, 0xA0, 0x40, 0x00, 0x2D, 0xEC, 0xF2, 0x00, 0x00, 0x00, 0x00, 0x00, 0x40, 0xD5, 0xCF, 0xAD, 0xD2, 0x06, 0xB9, 0xF5, 0x19, 0x93, 0x7B, 0x48, 0x1B, 0x43, 0x01, 0xE0, 0xEC, 0x32, 0x41, 0x96, 0x41, 0xFC, 0xEB, 0x9C, 0x5B, 0xAD, 0x56};
  KO_MEM_BYTE current_hp_offset_from_pattern = 0x70; // This should be interpreted as 4 bytes (uint32_t). 
